...
<script type="text/javascript">
 ...
 <div class="sectioncont funds-dtl myfunds-dtl">
    <div class="m_title" id="wallet"> Recent Withdraw </div>
      ...
      <div id="alldetail">
        ...
        <table id="funds" class='dataTable sf-grid all-funds-table table table-bordered' cellspacing="0" cellpadding="0">
            ...
            <tbody  role="alert" aria-live="polite" aria-relevant="all">
              <?php if (!empty($transactionList_BTC)) {
        $i = 0;
        foreach ($transactionList_BTC as $value) {
            echo '<tr>
    ...
    } elseif (empty($transactionList_BTC)) {

        echo "<tr><td colspan=\"3\">There is no Last Trading Activities exists </td><td></td></tr>";
    }
